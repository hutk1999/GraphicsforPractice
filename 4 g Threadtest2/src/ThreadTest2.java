...
public class ThreadTest2 {
   ...
   /**
    * The total number of primes found.  Each thread counts the 
    * number of primes in a different range of integers.  After it    
    * finishes counting, it adds its count to the total.
    */

   private static int total;
   
   /**
    * Adds x to total.  This method is synchronized so that it can be 
    * safely used by several different threads.
    */
    ...
    * the constructor.  After counting, the thread outputs a message 
    * about the number of primes that it has found, and it adds its 
    * count to the overall total by calling the addToTotal(int) 
    * method.
    */
    ...
    * using a specified number of threads.  The total elapsed time is 
    * printed.
