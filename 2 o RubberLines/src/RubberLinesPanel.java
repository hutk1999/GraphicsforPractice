...
public class RubberLinesPanel extends JPanel  {
   ...
   private class LineListener extends MouseAdapter implements MouseMotionListener {

   //    Note order: first: extends (only one class) then (no comma!): 
   //                      implements (perhaps several interfaces, separated by commas)
