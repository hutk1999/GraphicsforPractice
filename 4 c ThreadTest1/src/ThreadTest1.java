...
public class ThreadTest1 {
    ...
    * number of primes between 2 and 1000000.  It will print the      
    * result to standard output, along with its id number and the  
    * elapsed time between the start and the end of the computation.
    */
...
// An id number for this thread; specified in the constructor.
   ...
   /**
    * Start several CountPrintThreads.  The number of threads, 
    * between 1 and 25, is specified by the user.
    */
   ...
   public static void main(String[] args) {
	Scanner scan = new Scanner(System.in);
      ...
      System.out.println("\nCreating " + numberOfThreads + " prime" + 
                            "counting threads...");
...
/* If the assertion is false, an AssertionError is thrown
   Assertions are disabled by default. They are enabled by the class 
      loader: java -enableassertions <class-filename>  */
